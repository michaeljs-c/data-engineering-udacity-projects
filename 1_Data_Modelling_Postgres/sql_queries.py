...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time timestamp PRIMARY KEY, hour INT, day INT, month INT, year INT, weekday INT)
""")
...
time_table_insert = ("""INSERT INTO time (start_time, hour, day, month, year, weekday) VALUES (%s,%s,%s,%s,%s,%s) ON CONFLICT DO NOTHING
""")

# FIND SONGS

song_select = ("""SELECT song_id, a.artist_id FROM songs s JOIN artists a on a.artist_id = s.artist_id
